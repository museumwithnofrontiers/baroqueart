...
// — the rows, the AND/OR fold, the century presets and the search-language
// select are all `SearchFormView`'s; the field list and the target route are
// this website's, in `composables/search.js`.
</script>
